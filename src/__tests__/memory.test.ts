...
describe('MemorySystem', () => {
  ...
  describe('情景记忆', () => {
    it('应该能记录情景记忆', () => {
      (mockDb.get as ReturnType<typeof vi.fn>).mockReturnValue({ id: 1 });
    ...
    it('应该能获取情景记忆', () => {
      (mockDb.all as ReturnType<typeof vi.fn>).mockReturnValue([
  ...
  describe('声明式记忆', () => {
    it('应该能记住和回忆', () => {
      (mockDb.get as ReturnType<typeof vi.fn>)
        .mockReturnValueOnce(null) // 不存在
        .mockReturnValueOnce({ value: 'test_value', confidence: 0.8 }); // recall
    ...
    it('应该能设置和获取偏好', () => {
      (mockDb.get as ReturnType<typeof vi.fn>).mockReturnValue(null);
